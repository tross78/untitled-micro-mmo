...
const buildTree = () => {
  ...
  fillEllipse(rgba, 24, 13, 11, 8, 's');
  fillEllipse(rgba, 16, 17, 11, 8, 'p');
  fillEllipse(rgba, 32, 17, 11, 8, 'p');
  fillEllipse(rgba, 24, 21, 14, 10, 'p');
  fillEllipse(rgba, 18, 11, 7, 5, 'a');
  fillEllipse(rgba, 30, 11, 7, 5, 'a');
  fillEllipse(rgba, 24, 28, 8, 6, 's');
  fillRect(rgba, 21, 27, 6, 16, 'p');
  fillRect(rgba, 22, 30, 4, 14, 's');
  fillRect(rgba, 20, 28, 1, 15, 'o');
  fillRect(rgba, 27, 28, 1, 15, 'o');
  fillRect(rgba, 19, 40, 10, 2, 'o');
  fillRect(rgba, 17, 39, 3, 3, 's');
  fillRect(rgba, 28, 39, 3, 3, 's');
  fillTriangle(rgba, 14, 22, 10, 26, 16, 29, 's');
  fillTriangle(rgba, 34, 22, 32, 29, 38, 26, 's');
  const out = addOutline(rgba);
  fillEllipse(out, 24, 9, 4, 3, 'a');
  fillEllipse(out, 28, 15, 3, 2, 'a');
  fillEllipse(out, 19, 16, 3, 2, 'a');
  return out;
};
