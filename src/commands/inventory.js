import { localPlayer, players, pendingTrade, setPendingTrade } from '../state/store.js';
import { ITEMS, QUESTS, RECIPES } from '../content/data.js';
...
import { grantItem } from './helpers.js';
