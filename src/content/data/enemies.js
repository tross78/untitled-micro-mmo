...
export const ENEMIES = {
    ...
    ruin_shade:  defineEnemy('ruin_shade',  { name: 'Ruin Shade',  hp: 24, attack: 8,  defense: 0, xp: 24, loot: ['old_tome', 'gold', 'potion', 'bone'], color: '#0af' }),
    ...
    skeleton:    defineEnemy('skeleton',    { name: 'Skeleton',       hp: 45, attack: 15, defense: 5, xp: 75, loot: ['old_tome', 'gold', 'bone'], color: '#0af' }),
    wraith:      defineEnemy('wraith',      { name: 'Wraith',         hp: 60, attack: 20, defense: 0, xp: 120, loot: ['old_tome', 'magic_staff'], color: '#f0f' }),
    mountain_troll: defineEnemy('mountain_troll', { name: 'Mountain Troll', hp: 90, attack: 22, defense: 9, xp: 220, loot: ['iron_key', 'gold', 'steel_sword', 'bone'], color: '#ff0' }),
