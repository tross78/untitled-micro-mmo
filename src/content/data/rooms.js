...
export const rooms = {
    cellar: defineRoom('cellar', {
        ...
        width: 10, height: 10,
        exits: {"north":"hallway"},
        exitTiles: "4,0,hallway,5,10,door,3,1",
    ...
    tavern: defineRoom('tavern', {
        ...
        exitTiles: "5,10,hallway,5,0,door,3,1|11,5,market,0,7,door",
    ...
    market: defineRoom('market', {
        ...
        exitTiles: "0,6,tavern,11,5,door,1,3|6,14,crossroads,5,0,edge,3,1",
